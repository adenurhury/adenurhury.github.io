  ...
  data () {
    return {
      ...
      indicatorList: [
        ...
        { isActive: false, id: '#ContactManager', title: 'PKL', linkId: '4' },
        { isActive: false, id: '#MemoryGame', title: 'Universitas', linkId: '5' },
        { isActive: false, id: '#TumblrcClone', title: 'more', linkId: '6' },
        { isActive: false, id: '#Footer', title: 'Contact Us', linkId: '7' }
      ],
      backgrounds: [{ url: 'assets/background-image/background6.jpeg' }],
      postedBy: [
        {
          artistName: 'Nur',
          artistAvatar: 'avatar'
